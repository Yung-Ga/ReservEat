...
<div class="container py-4">
    <%@ include file="menu.jsp" %>  
     <%!String greeting = "Welcome to ReservEat!"; String tagline = "Welcome to ReservEat!";%>    
      ...
      <div class="col-md-12">
        <div class="h-100 p-5">
          <div class="mb-3">
              ...
              <div class="btn-custom-container">
                  <button type="button" class="btn-custom">
                      <img src="./resources/images/padthai.png" alt="Icon 4">
                  </button>
                  <div>아시안</div>
              </div>
              <div class="btn-custom-container">
                  <button type="button" class="btn-custom">
                      <img src="./resources/images/alcohol.png" alt="Icon 5">
                  </button>
                  <div>술</div>
              </div>
              <div class="btn-custom-container">
